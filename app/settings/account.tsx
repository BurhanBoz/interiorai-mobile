/**
 * Account & data — everything the redesigned Settings screen does not show.
 *
 * <p>The spec's Settings carries four rows. Seven destinations lived on the
 * old one, and one of them is not optional: **account deletion is an App
 * Store requirement** (5.1.1(v)) and has to stay reachable. Billing history,
 * plan management and the legal texts are in the same position — rarely
 * wanted, never removable.
 *
 * <p>So they moved here rather than disappearing, and Settings opens this by
 * tapping your own name. That keeps the four-row screen the spec asks for and
 * the deletion path a reviewer can find.
 *
 * <p>This file is the previous Settings screen, moved. Its list, its delete
 * flow and its confirmation dialogs are unchanged.
 */
